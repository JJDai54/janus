...
global $helper;
    ...
    //if (is_null($fileName)) $fileName = JANUS_PATH_CSS . "/style-item-color.css";
...
function load_trierTableauHTML(){
    $url = XOOPS_URL . "/Frameworks/janus/js/trierTableauHTML/trierTableau.js";
...
//   $xoTheme->addScript('browse.php?Frameworks/zoom/highslide.js');
    ...
    if(file_exists(XOOPS_ROOT_PATH . "/modules/{$moduleDirName}/assets/js/config_highslide.js"))
    {
      ...
      $xoTheme->addScript(XOOPS_URL . "/Frameworks/janus/js/config_highslide.js");
    }
